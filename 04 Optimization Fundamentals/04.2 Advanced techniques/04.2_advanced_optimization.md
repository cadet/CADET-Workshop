...
- provide useful feedback during (long) optimization runs.
...
optimization_problem.add_variable(
    ...
    parameter_path='flow_sheet.column.length',
    lb=0, ub=1,
)
```
...
process_2.name = 'another process with a different name'
...
print(optimization_problem.objective_labels)
```
